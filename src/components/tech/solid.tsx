...
export const Solid = () => {
  return (
    <a
      ...
      target='_blank'
      class='inline-flex items-center justify-center p-5 text-base font-medium text-[#2c4f7c] rounded-md bg-gray-50 hover:text-[#446b9e] hover:bg-gray-100'
    >
      <svg
      ...
      <span class='relative text-transparent bg-clip-text bg-gradient-to-r from-[#335d92] to-[#2c4f7c] w-full'>
